...
Route::group(['before' => 'auth|standardUser'], function()
{
	...
	Route::resource('agendas', 'AgendasController');
		...
		Route::get('/proyectos/ver', 'ProyectosController@ver');
		Route::get('/proyectos/{id}/delete', 'ProyectosController@destroy');
		Route::get('/proyectos/{id}/publicar', 'ProyectosController@publicar');

		Route::get('/proyectos/{id}/nuevoestado', 'ProyectosController@createestado');


		Route::get('/proyectos/{id}/archivos/{padre}', 'ArchivosController@index');

		Route::post( '/proyectos/storeestado', array(
				'as' => 'proyectos.storeestado',
				'uses' => 'proyectosController@storeestado'
		) );
