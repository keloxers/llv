...
class ArchivosController extends BaseController {
	...
	public function index($id, $padre)
	{
				...
				// $articulo = DB::table($padre . 's')->where('id', '=', $id)->first();
        ...
        $title = "Archivos";
				...
				return View::make('archivos.index', array('title' => $title, 'archivos' => $archivos, 'padre' => $padre, 'padre_id' => $id));
	...
	public function store()
	{
		...
		return Redirect::to('/' . $padre . 's/ver');
